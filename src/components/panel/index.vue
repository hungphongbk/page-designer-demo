<template>
  <div>
    <ul class="tab tab-block panel-tab">
      <li class="tab-item" :class="{active: activeTab === 1}" @click="activeTab = 1"><a>Parameters</a></li>
      <li class="tab-item" :class="{active: activeTab === 2}" @click="activeTab = 2"><a>Interactions</a></li>
      <li class="tab-item" :class="{active: activeTab === 3}" @click="activeTab = 3"><a>Animations</a></li>
    </ul>
